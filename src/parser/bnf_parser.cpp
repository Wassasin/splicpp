...
namespace splicpp
{
		...
		void bnf_parser::parse_syntax(grammar& g, const std::string str, const cst_node n) const //syntax :== rule | syntax newline rule
		{
		...
		void bnf_parser::parse_rule(grammar& g, const std::string str, const cst_node n) const //rule :== rule-name assignment expr
		{
		...
		void bnf_parser::parse_expr(grammar& g, const std::string str, const cst_node n, const stid start) const //expr :== list | expr expr-sep list
		{
		...
		void bnf_parser::parse_list(grammar& g, const std::string str, const cst_node n, rule& r) const //list :== rule-name | list rule-name
		{
		...
		std::string bnf_parser::parse_rule_name(const std::string str, const token t) const
		{
