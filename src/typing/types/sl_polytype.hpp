...
namespace splicpp
{
	...
	public:
		...
		virtual cs_ptr<sl_polytype> apply(const typecontext& c, const substitution& s) const = 0;
		
		virtual void print(std::ostream& s) const = 0;
		
		static cs_ptr<sl_polytype> qualify(const typecontext& c, const cs_ptr<sl_type> t);
		static cs_ptr<sl_polytype> not_qualify(const cs_ptr<sl_type> t);
	};
	...
	public:
		...
		virtual cs_ptr<sl_polytype> apply(const typecontext& c, const substitution& s) const;
		
		virtual void print(std::ostream& s) const;
		
		static cs_ptr<sl_polytype_forall> qualify(const typecontext& c, const cs_ptr<sl_type> t);
		static cs_ptr<sl_polytype_forall> not_qualify(const cs_ptr<sl_type> t);
	};
