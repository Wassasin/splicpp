...
namespace splicpp
{
	...
	{
		return cs_ptr<sl_type>(new sl_type_int());
	}
	...
	{
		return cs_ptr<sl_type>(new sl_type_tuple(t_left->fetch_type(c), t_right->fetch_type(c)));
	}
	...
	{
		return cs_ptr<sl_type>(new sl_type_array(t->fetch_type(c)));
	}
