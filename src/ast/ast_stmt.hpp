...
namespace splicpp
{
	...
	public:
		...
		virtual s_ptr<const ir_stmt> translate(const ir_temp return_reg, ircontext& c) const = 0;
	};
	...
	public:
		...
		virtual s_ptr<const ir_stmt> translate(const ir_temp return_reg, ircontext& c) const;
	};
